...
// Datos de Red
const char* ssid = "Totalplay-F8A3";  // Pon aquí el nombre de la red a la que deseas conectarte
const char* password = "F8A315174f7TWvZr";  // Escribe la contraseña de dicha red
